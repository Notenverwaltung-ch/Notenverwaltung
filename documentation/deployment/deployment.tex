...
sudo apt-get install docker-compose
    ...
    \lstinputlisting[language=yml, label={lst:ComposeReverseProxy}, caption={docker-compose.yml für den Reverse Proxy}]{compose/reverse-proxy.yml}
    ...
    \lstinputlisting[language=yml, label={lst:ComposeDb}, caption={docker-compose.yml für die Datenbank + PgAdmin}]{compose/db-pgadmin.yml}
    ...
    \lstinputlisting[language=yml, label={lst:ComposeApi}, caption={docker-compose.yml für den Spring Service}]{compose/api.yml}
    ...
    \lstinputlisting[language=yml, label={lst:ComposeFrontend}, caption={docker-compose.yml für das Angular Frontend}]{compose/frontend.yml}
