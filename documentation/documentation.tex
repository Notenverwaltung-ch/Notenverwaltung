...
pg_dump -h localhost -p 5432 -U postgres -d notenverwaltung -F p -f documentation/dump/backup_nv_final.sql
    ...
    Die vollständige OpenAPI/Swagger-Dokumentation der REST-API befindet sich im Ordner \code{documentation/swagger/}
    (\code{documentation/swagger/documentation.json}).
    ...
    \href{https://github.com/Notenverwaltung-ch/Notenverwaltung/releases/tag/25.0.17}{Release 25.0.17}
