...
% ---------------- Umsetzungsbeschreibung ----------------
    ...
    \begin{itemize}
        \item \textbf{Controller-Schicht}: REST-Endpoints (z. B. \code{/api/public/auth}, \code{/api/subjects}, \code{/api/semesters}, \code{/api/classes}, \code{/api/tests}, \code{/api/admin/users})
        ...
        \item \textbf{Domain\/Model}: JPA-Entities (z. B. \code{Semester}, \code{Subject}, \code{Class}, \code{Test}, \code{Grade}, \code{User}, \code{Role}).
    \end{itemize}
